  ...
  return (
    <header role="banner" className="fixed top-0 left-0 right-0 z-50 w-full py-4 px-6 border-b border-slate-200/50 bg-white/70 backdrop-blur-md text-slate-900 transition-all">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        <div className="text-xl font-serif font-bold tracking-tight text-slate-900 flex items-center gap-2">
        ...
        <nav className="hidden md:block">
          <ul className="flex gap-8 text-sm font-medium">
            <li><a href="#services" className="hover:text-blue-600 transition-colors">Szolgáltatások</a></li>
            <li><a href="#about" className="hover:text-blue-600 transition-colors">Rólunk</a></li>
            <li><a href="#contact" className="bg-slate-900 text-white px-5 py-2 rounded-full hover:bg-slate-800 transition-all shadow-sm">Kapcsolat</a></li>
          </ul>
        </nav>
